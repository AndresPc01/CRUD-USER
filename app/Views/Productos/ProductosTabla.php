                ...
                <tbody>
                    <tr>
                        <?php if ($fila['estado_producto'] === 'Habilitado') {
                            ...
                            <td><a href="ActualizarProducto?idproducto=<?php echo $fila['idproducto']; ?>&nombre_producto=<?php echo urlencode($fila['nombre_producto']); ?>&cantidad=<?php echo $fila['cantidad']; ?>&precio_unidad=<?php echo $fila['precio_unidad']; ?>&idproveedorfk=<?php echo $fila['idproveedorfk']; ?>&estado_producto=<?php echo urlencode($fila['estado_producto']); ?>"
                                    class="btn btn-primary">Actualizar</a>
                            </td>


                            <td><a href="EstadoProducto?idproducto=<?php echo $fila['idproducto'] ?>&estado_producto=<?php echo $fila['estado_producto'] ?> "
